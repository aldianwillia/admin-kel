...
<div class="col-auto ma" style="margin-bottom: 10px">
    <a href="pendudukexport"  class="btn btn-primary" >
        Export Excel +
    </a>
</div>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          ...
          <a href="/datapenduduks/delete/{{ $item->nik }}" class="btn btn-danger btn-sm" onclick="return confirm('Apa kamu yakin ingin mengahpus data {{ $item->nama }}')">Hapus</a>
        </td>
      </tr>
      @endforeach   
    </tbody>
